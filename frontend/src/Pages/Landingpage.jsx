...
const Landingpage = () => {
  return (
    <>
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center text-white overflow-hidden"
          style={{ backgroundImage: `url(${hero_img})` }}>
          <div className="bg-black bg-opacity-50 p-4 sm:p-6 md:p-10 rounded-lg text-center h-full w-full flex flex-col justify-center space-y-2 sm:space-y-3 md:space-y-4 py-8 sm:py-12">
            ...
            <p className='text-white text-sm sm:text-base md:text-xl lg:text-xl xl:text-2xl font-semibold text-center mx-auto px-4 sm:px-8 md:px-16 lg:px-32 max-w-[650px] sm:max-w-[850px] leading-snug'>Experience the perfect blend of specialty coffee, carefully crafted dishes, and warm hospitality in a cozy atmosphere</p>
